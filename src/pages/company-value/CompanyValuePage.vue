...
export default defineComponent({
  ...
  data() {
    return {
      ...
      companyValuesID: [] as companyValue[],
      companyValuesJP: [] as companyValue[],
  ...
  <div class="bg-white border border-4 rounded-lg shadow relative m-4">
    <TabsComposition>
      <TabComposition title="English">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in companyValues" :key="item.id">
            ...
            <td class="p-4 border-b border-slate-200">
              <div class="flex gap-2 justify-end">
                <router-link :to="{name: 'edit-company-value', params: { id: item.id }}" class="btn btn-primary">
                  <VaButton
                    preset="primary"
                    size="medium"
                    icon="mso-edit"
      ...
      <TabComposition title="Indonesia">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in companyValuesID" :key="item.id">
            <td class="p-4 border-b border-slate-200">
              {{ item.id }}
            </td>
            <td class="p-4 border-b border-slate-200">
      ...
      <TabComposition title="Japan">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in companyValuesJP" :key="item.id">
            <td class="p-4 border-b border-slate-200">
              {{ item.id }}
            </td>
            <td class="p-4 border-b border-slate-200">
