...
export default defineComponent({
  ...
  data() {
    return {
      ...
      frontPageListID: [] as Frontpage[],
      frontPageListJP: [] as Frontpage[],
    };
  },
  created() {
    this.getFrontPage();
