...
export default defineComponent({
  ...
  data() {
    return {
      ...
      joinPageListID: [] as JoinPage[],
      joinPageListJP: [] as JoinPage[],
    };
  },
  created() {
    this.getJoinPage();
    ...
    <TabsComposition>
      ...
      <TabComposition title="Indonesia">
        <table class="text-left table-auto border-collapse">
          ...
          <tbody>
            <tr class="hover:bg-slate-50" tr v-for="item in joinPageListID" :key="item.id">
              <td class="align-top p-4 border-b border-slate-200">
                {{ item.id }}
              </td>
              <td class="align-top p-4 border-b border-slate-200">
      ...
      <TabComposition title="Japan">
        <table class="text-left table-auto border-collapse">
          ...
          <tbody>
            <tr class="hover:bg-slate-50" tr v-for="item in joinPageListJP" :key="item.id">
              <td class="align-top p-4 border-b border-slate-200">
                {{ item.id }}
              </td>
              <td class="align-top p-4 border-b border-slate-200">
