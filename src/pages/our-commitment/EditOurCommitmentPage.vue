...
export default defineComponent({
  ...
  methods: {
    async getAboutPage(): Promise<void> {
      ...
      const docRef = doc(db, "ourCommitments",id );
    ...
    async onSubmit (evt: { preventDefault: () => void; }) {
      ...
      // console.log("submit")
      const id = this.key.toString()
      this.$router.push({ name: 'our-commitment' })
      await updateDoc(doc(db, 'ourCommitments', id), {
          ...
          <div class="grid grid-cols-6 gap-6">
            <div class="col-span-full">
              ...
              <div class="col-span-full">
                  ...
                  <input type="text" name="subTitle2" id="subTitle2" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" v-model="board.subTitle2">
                </div>
                <div class="col-span-full">
                  <label for="subTitle3" class="text-sm font-medium text-gray-900 block mb-2">Subtitle3</label>
                  <input type="text" name="subTitle3" id="subTitle3" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" v-model="board.subTitle3">
                </div>
                <div class="col-span-full">
                  <label for="subTitle4" class="text-sm font-medium text-gray-900 block mb-2">Subtitle4</label>
                  <input type="text" name="subTitle4" id="subTitle4" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" v-model="board.subTitle4">
                </div>
