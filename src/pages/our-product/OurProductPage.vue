...
export default defineComponent({
  ...
  data() {
    return {
      OurProduct: [] as OurProduct[],
      OurProductID: [] as OurProduct[],
      OurProductJP: [] as OurProduct[],
  ...
  methods: {
    async getOurProduct(): Promise<void> {
  ...
  <div class="bg-white border border-4 rounded-lg shadow relative m-4">
    <TabsComposition>
      <TabComposition title="English">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in OurProduct" :key="item.id">
      ...
      <TabComposition title="Indonesia">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in OurProductID" :key="item.id">
            <td class="p-4 border-b border-slate-200">
              {{ item.id }}
            </td>
            <td class="p-4 border-b border-slate-200">
      ...
      <TabComposition title="Japan">
        ...
        <tbody>
          <tr class="hover:bg-slate-50" tr v-for="item in OurProductJP" :key="item.id">
            <td class="p-4 border-b border-slate-200">
              {{ item.id }}
            </td>
            <td class="p-4 border-b border-slate-200">
