...
export default defineComponent({
  ...
  data() {
    return {
      ...
      productsID: [] as products[],
      productsJP: [] as products[]
  ...
  <div class="bg-white border border-4 rounded-lg shadow relative m-4">
    <TabsComposition>
      ...
      <TabComposition title="Indonesia">
          ...
          <tbody>
            <tr class="hover:bg-slate-50" tr v-for="item in productsID" :key="item.id">
              <td class="align-top p-4 border-b border-slate-200">
                {{ item.id }}
              </td>
              <td class="align-top p-4 border-b border-slate-200">
      ...
      <TabComposition title="Japan">
          ...
          <tbody>
            <tr class="hover:bg-slate-50" tr v-for="item in productsJP" :key="item.id">
              <td class="align-top p-4 border-b border-slate-200">
                {{ item.id }}
              </td>
              <td class="align-top p-4 border-b border-slate-200">
